...
try:
    ...
    print("✅ Đã load disease classes!")
     ...
     # Load class names for LIME
    with open(r'D:\BigData And DataMining\Đồ án\model\class_names.json', 'r') as f:
        class_names = json.load(f)
    print("✅ Đã load class names!")
    
    # Load training sample for LIME
    X_train_sample = joblib.load(r'D:\BigData And DataMining\Đồ án\model\X_train_sample.pkl')
    print("✅ Đã load training sample!")
    
    # Load feature display names
    with open(r'D:\BigData And DataMining\Đồ án\model\feature_display_names.json', 'r', encoding='utf-8') as f:
        feature_display_names = json.load(f)
    print("✅ Đã load feature display names!")
    
    # Setup LIME explainer
    def predict_proba_for_lime(X):
        """Hàm predict cho LIME"""
